...
function add_css() {
	...
	style.id = "svelte-1jm30tb-style";
	style.textContent = "#globe-overlay.svelte-1jm30tb{position:absolute;top:0;left:0}.location-info.svelte-1jm30tb{background-color:rgba( 51, 101, 95, 0.9 );margin:20px 10px;padding:10px;color:white;border-radius:5px;max-width:300px}";
	Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["append"])(document.head, style);
}

// (445:1) {#if locationSelected !== null }
function create_if_block(ctx) {
	let div;
	let h3;
	let t_value = /*locationSelected*/ ctx[2].label + "";
	let t;
	...
	return {
		c() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(div, "class", "location-info svelte-1jm30tb");
		},
		m(target, anchor) {
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["insert"])(target, div, anchor);
		...
		p(ctx, dirty) {
			if (dirty[0] & /*locationSelected*/ 4 && t_value !== (t_value = /*locationSelected*/ ctx[2].label + "")) Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["set_data"])(t, t_value);
		},
		d(detaching) {
			if (detaching) Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["detach"])(div);
		}
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*locationSelected*/ ctx[2] !== null && create_if_block(ctx);
	...
	return {
		c() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(div, "style", /*overlayStyle*/ ctx[5]);
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(div, "class", "svelte-1jm30tb");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["listen"])(div, "mousedown", /*handleDragStart*/ ctx[6]),
					Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["listen"])(div, "touchstart", /*handleDragStart*/ ctx[6], { passive: true })
				];
		...
		p(ctx, dirty) {
			...
			if (/*locationSelected*/ ctx[2] !== null) {
				if (if_block) {
 ...
 */
	...
	const getMap = () => {
		return new Promise((resolve, reject) => {
				...
				Object(d3_fetch__WEBPACK_IMPORTED_MODULE_2__["json"])(mapUrl).then(data => {
					$$invalidate(13, map = topojson.feature(data, data.objects[mapCollection]));
					resolve(data);
				}).catch(err => {
					reject(err);
				});
	...
	const prepareData = raw_data => {
		...
		result.forEach(d => {
			...
			d._canvasLabel = new _helpers_canvas__WEBPACK_IMPORTED_MODULE_4__["Label"](context, labelX, labelY, d.label);
			d._canvasLabel.align(labelAlign).textColor("#ECECEC").bgColor("#33655F").font("Lato 10px");
		});
	...
	function isVisibleOnGlobe(datapoint) {
		...
		return Object(d3_geo__WEBPACK_IMPORTED_MODULE_3__["geoDistance"])(dataloc, center) < 1.55;
	}
 ...
 */
	const handleDragStart = evt => {
		...
		dragPosition = Object(_helpers_canvas__WEBPACK_IMPORTED_MODULE_4__["getMousePosition"])(evt);
		...
		if (timeDif < 500) {
			...
			if (mapData.length > 0) {
				const idx = mapData.findIndex(d => {
					return Object(_helpers_canvas__WEBPACK_IMPORTED_MODULE_4__["detectCircularCollision"])({ x: dragPosition[0], y: dragPosition[1] }, d, 10) || Object(_helpers_canvas__WEBPACK_IMPORTED_MODULE_4__["detectBoxCollision"])({ x: dragPosition[0], y: dragPosition[1] }, d._canvasLabel.box());
				});

				if (idx > -1) {
					$$invalidate(2, locationSelected = mapData[idx]);
					isRotating = false;
				} else {
					$$invalidate(2, locationSelected = null);
 ...
 */
	...
	$$self.$$set = $$props => {
		if ("mapUrl" in $$props) $$invalidate(7, mapUrl = $$props.mapUrl);
		if ("dataUrl" in $$props) $$invalidate(8, dataUrl = $$props.dataUrl);
		if ("mapCollection" in $$props) $$invalidate(9, mapCollection = $$props.mapCollection);
 ...
 * STYLING
 */
			$: $$invalidate(5, overlayStyle = `width: ${width}px; height: ${height}px;`);
		}

		if ($$self.$$.dirty[0] & /*width, margin*/ 1025) {
			/**
 * REACTIVE
 */
			$: $$invalidate(20, graphWidth = width - margin.left - margin.right);
		}

		if ($$self.$$.dirty[0] & /*height, margin*/ 1026) {
			$: $$invalidate(21, graphHeight = height - margin.top - margin.bottom);
		}

		if ($$self.$$.dirty[0] & /*margin, graphWidth, graphHeight, map*/ 3154944) {
			$: $$invalidate(22, projection = Object(d3_geo__WEBPACK_IMPORTED_MODULE_3__["geoOrthographic"])().fitExtent([[margin.left, margin.top], [graphWidth, graphHeight]], map));
		}

		if ($$self.$$.dirty[0] & /*projection*/ 4194304) {
...
class Globe extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponent"] {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-1jm30tb-style")) add_css();
